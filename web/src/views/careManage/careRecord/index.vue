<template>
    <div class="page-container main-view">
                        ...
                        <el-table-column label="操作" width="250" fixed="right" class-name="small-padding fixed-width">
                            <template #default="scope">
                                <el-button
                                    :text="true"
                                    type="primary"
                                    @click="openCareRecord(scope.row)">
                                    查看护理记录
                                </el-button>
                            </template>
                        </el-table-column>
        ...
        <CareRecordDialog
            ref="CareRecordDialogRef"></CareRecordDialog>
    </div>
</template>
...
import CareRecordDialog from './components/CareRecordDialog.vue';
...
export default defineComponent({
    ...
    setup() {
        ...
        const CareRecordDialogRef = ref(null);
     ...
     /** 搜索按钮操作 */
        const handleQuery = async () => {
            ...
            function openCareRecord(row) {
            if (CareRecordDialogRef.value) {
                CareRecordDialogRef.value.open({ clientId: row.clientId }); // ✅ 正确传对象
            }
            }
